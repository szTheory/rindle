...
If you use the S3 adapter, also choose an ExAws HTTP client. Rindle's tested
path uses Req so the S3 and GCS adapters share the same maintained transport:
