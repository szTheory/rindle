...
- [ ] 96-02-PLAN.md — Add the six Level-1 `.ck-*` primitives (table/stat/form/tabs/detail/toolbar) + the `Tabs` WAI-ARIA hook.
...
- [ ] 96-05-PLAN.md — Author `cohort-styleguide.spec.js` (reduced-motion probe, theme toggle + polish warn-mode, component-existence, auto-fallback probe).
