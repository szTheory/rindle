...
- [x] 125-09-PLAN.md — Retire the aggregate and wire all four domains into the unchanged Proof topology.

**Wave 10 — finite evidence and issue disposition** *(blocked on Wave 9)*

- [x] 125-10-PLAN.md — Run the 25 fresh-process matrix, exact-head supported CI, and close-or-narrow #42.
...
- [ ] 126-03-PLAN.md — Probe and reconcile task, Admin, and runtime-check warnings.
...
- [ ] 126-05-PLAN.md — Probe and reconcile GCS and Local stream/opaque warnings.

**Wave 6 — S3 adapter** *(blocked on Wave 5)*

- [ ] 126-06-PLAN.md — Probe and reconcile S3 stream/tail warnings.

**Wave 7 — Tus and Mux boundaries** *(blocked on Wave 6)*

- [ ] 126-07-PLAN.md — Probe and reconcile Tus crypto and Mux response-pattern warnings.

**Wave 8 — facade and lifecycle atoms** *(blocked on Wave 7)*

- [ ] 126-08-PLAN.md — Reconcile facade, Broker, and PromoteAsset atoms and complete all 45 dispositions.

**Wave 9 — exact-head authority and immutable issue receipt** *(blocked on Wave 8)*

- [ ] 126-09-PLAN.md — Run final gates, require unchanged-head Nightly/PR success, and publish the external #76 receipt.
...
| 126. Curated Type Ratchet | 0/9 | Planned | - |
