...
- [x] 113-03-PLAN.md — D-08 public_smoke junit hardening + D-07 corrected root-cause prose (runbook + ledger) (Track A)
- [x] 113-04-PLAN.md — Human token-rotation checkpoint → observe 0.3.2 publish → truth-reconciliation edits (Track B, gated)
...
| 116. Versioned `Rindle.Migration` Module | 3/7 | In Progress|  |
