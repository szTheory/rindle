...
Plans:
- [ ] 98-01-PLAN.md — page/1 scaffold + all generated-CSS (two-pane §A, motion §B, mobile-first §C, focus-visible §D) authored in admin-css-build.mjs, byte-synced, drift-gated (page/1 unused)
