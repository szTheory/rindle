...
- [x] 34-04-telemetry-parity-PLAN.md — Cross-cutting redaction-parity test + telemetry contract `@moduledoc` documentation + Dialyzer PLT regen + end-to-end smoke (MUX-08) — 2026-05-06
