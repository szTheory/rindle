# Requirements Archive: v1.17 Adopter-Confidence Hygiene
...
Micro milestone (Branch C). No new public API. Execute phases **78 → 79 → 80**.
...
- [x] **CI-04**: Maintainer records an explicit decision on Credo and Dialyzer severity
  ...
  — **Validated** (Phase 79; decision: advisory)
...
*Archived: 2026-05-27 after v1.17 milestone close*
