# Requirements Archive: v1.6 Provider Boundary + Mux
...
- [x] **MUX-01**: `mux ~> 3.2` and `jose ~> 1.11` ship as **optional** deps;
...
- [x] **MUX-02**: `Rindle.Streaming.Provider.Mux` implements every locked
  ...
  `Application.get_env`.
- [x] **MUX-03**: A new `Rindle.Workers.MuxIngestVariant` Oban worker pushes a
...
- [x] **MUX-04**: Signed HLS playback URLs mint via Mux's own JOSE-based
...
- [x] **MUX-05**: `MuxIngestVariant` is idempotent under Oban `unique`
  constraints keyed on `(asset_id, profile, variant_name)`; re-running yields
  the same `media_provider_assets` row, never a duplicate.
- [x] **MUX-06**: Atomic-promote rule on flip-to-`ready`: re-fetch the source
...
- [x] **MUX-07**: A defensive `Rindle.Workers.MuxSyncProviderAsset` Oban worker
...
- [x] **MUX-08**: Provider ingest and sync emit telemetry under
...
| MUX-01..08 | Phase 34 | Validated 2026-05-06 |
| MUX-09..14 | Phase 35 | Validated 2026-05-07 |
| MUX-15..19 | Phase 36 | Validated 2026-05-07 |
| MUX-20..23 | Phase 37 (optional) | Deferred to v1.7 (Phase 37 not pulled forward) |
...
| MUX-01 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-02 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-03 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-04 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-05 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-06 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-07 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-08 | Phase 34 — Mux REST Adapter + Server-Push Sync | Validated 2026-05-06 |
| MUX-09 | Phase 35 — Signed-Webhook Plug + Idempotent Ingest | Validated 2026-05-07 |
| MUX-10 | Phase 35 — Signed-Webhook Plug + Idempotent Ingest | Validated 2026-05-07 |
| MUX-11 | Phase 35 — Signed-Webhook Plug + Idempotent Ingest | Validated 2026-05-07 |
| MUX-12 | Phase 35 — Signed-Webhook Plug + Idempotent Ingest | Validated 2026-05-07 |
| MUX-13 | Phase 35 — Signed-Webhook Plug + Idempotent Ingest | Validated 2026-05-07 |
| MUX-14 | Phase 35 — Signed-Webhook Plug + Idempotent Ingest | Validated 2026-05-07 |
| MUX-15 | Phase 36 — Public DX, Onboarding, CI Proof | Validated 2026-05-07 |
| MUX-16 | Phase 36 — Public DX, Onboarding, CI Proof | Validated 2026-05-07 |
| MUX-17 | Phase 36 — Public DX, Onboarding, CI Proof | Validated 2026-05-07 |
| MUX-18 | Phase 36 — Public DX, Onboarding, CI Proof | Validated 2026-05-07 |
| MUX-19 | Phase 36 — Public DX, Onboarding, CI Proof | Validated 2026-05-07 |
| MUX-20 | Phase 37 (optional) — Browser → Mux Direct Creator Upload | Deferred to v1.7 |
| MUX-21 | Phase 37 (optional) — Browser → Mux Direct Creator Upload | Deferred to v1.7 |
| MUX-22 | Phase 37 (optional) — Browser → Mux Direct Creator Upload | Deferred to v1.7 |
| MUX-23 | Phase 37 (optional) — Browser → Mux Direct Creator Upload | Deferred to v1.7 |
