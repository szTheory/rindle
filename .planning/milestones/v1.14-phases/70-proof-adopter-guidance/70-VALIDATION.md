...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 70-01-01 | 01 | 1 | PROOF-05 | T-70-01 / — | Shared fixtures reduce drift across batch tests | unit | `mix test test/rindle/owner_erasure_batch_test.exs` | ✅ | ✅ green |
| 70-01-02 | 01 | 1 | PROOF-05 | T-70-02 / — | Partial failure does not roll back committed owners | integration | `mix test test/rindle/owner_erasure_batch_proof_test.exs` | ✅ | ✅ green |
| 70-01-03 | 01 | 1 | PROOF-05 | T-70-02 / — | First-owner failure returns empty partial_report | integration | same | ✅ | ✅ green |
| 70-02-01 | 02 | 2 | TRUTH-03 | T-70-03 / — | Guides document batch without duplicating mix contract | docs parity | `mix test test/install_smoke/docs_parity_test.exs` | ✅ | ✅ green |
| 70-02-02 | 02 | 2 | TRUTH-03 | T-70-03 / — | Stale bulk-orchestration deferral removed | docs parity | same | ✅ | ✅ green |
...
Wave 0 creates:
- [x] `test/support/owner_erasure_batch_fixtures.ex`
- [x] `test/support/counting_failing_txn_repo.ex`
- [x] `test/rindle/owner_erasure_batch_proof_test.exs`
