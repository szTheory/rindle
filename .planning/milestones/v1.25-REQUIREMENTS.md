# Requirements Archive: v1.25 Maintainer Craft & Feedback Velocity

**Archived:** 2026-08-27
**Status:** SHIPPED

For current project status, see `.planning/PROJECT.md` and `.planning/ROADMAP.md`. A future milestone
creates a fresh `.planning/REQUIREMENTS.md` only after an approved signal.
...
**Status:** Complete — 18/18 verified
