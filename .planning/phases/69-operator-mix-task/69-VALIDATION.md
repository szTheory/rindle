...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 69-01-01 | 01 | 1 | OPS-02 | T-69-01 | Default preview; execute requires explicit flag | integration | `mix test test/rindle/batch_owner_erasure_task_test.exs` | ❌ W0 | ⬜ pending |
| 69-01-02 | 01 | 1 | OPS-02 | T-69-02 | `String.to_existing_atom/1` for owner_type | unit | `mix test test/rindle/batch_owner_erasure_task_test.exs` | ❌ W0 | ⬜ pending |
| 69-02-01 | 02 | 2 | OPS-02 | — | N/A | unit | `mix test test/rindle/api_surface_boundary_test.exs` | ✅ | ⬜ pending |
| 69-02-02 | 02 | 2 | OPS-02 | — | N/A | integration | `mix test test/rindle/batch_owner_erasure_task_test.exs` | ❌ W0 | ⬜ pending |
...
- [ ] `test/rindle/batch_owner_erasure_task_test.exs` — task test module (created in plan 02)
- [ ] `lib/mix/tasks/rindle.batch_owner_erasure.ex` — task module (created in plan 01)
