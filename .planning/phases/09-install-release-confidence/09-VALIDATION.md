...
| 09-02-01 | 02 | 2 | RELEASE-02 | T-09-03 | PR CI builds and unpacks the package artifact, generates a consumer app, and runs the same narrow smoke lane from the built artifact | CI contract | `rg -n \"hex.build --unpack|install_smoke|generated_app_smoke|phx.new\" .github/workflows/ci.yml .github/workflows/release.yml` | ❌ Wave 0 | ⬜ pending |
