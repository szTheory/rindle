...
key-decisions:
  - "Bind Plan 05 to 9d8e7e3a16f35f69ce6e8fa4f1b476afc491a2fa and reject every later non-planning delta."
...
`9d8e7e3a16f35f69ce6e8fa4f1b476afc491a2fa`. Every local authority passed after
...
The census itself found and fixed two unattended-execution hazards: resuming a
discovered CI run could otherwise retrigger it after interruption, and Phoenix 1.8.9
could wait on an install prompt when invoked through `System.cmd`. Both now have
...
- Controller, policy, and topology: 38 tests, 0 failures.
