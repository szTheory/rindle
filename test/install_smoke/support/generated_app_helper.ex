...
defmodule Rindle.InstallSmoke.GeneratedAppHelper do
  ...
  defp patch_generated_app!(
    ...
    migration_version =
      write_rindle_migration!(root, compile_prefix, migration_kind)
  ...
  defp write_rindle_migration!(root, prefix, migration_kind) do
    {migration_version, migration_source} =
      case migration_kind do
        :install ->
          {@rindle_migration_version, Contracts.rindle_migration_source(prefix)}

        :directional_upgrade ->
          {@directional_migration_version, Contracts.directional_migration_source()}

        :legacy_upgrade ->
          {@directional_migration_version, Contracts.legacy_upgrade_migration_source()}
      end
